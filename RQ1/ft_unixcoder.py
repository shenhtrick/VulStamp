...
from transformers import RobertaTokenizer, T5ForSequenceClassification, RobertaForSequenceClassification
...
model_path = "../../models/codereviewer"
...
os.makedirs('result/code/pred', exist_ok=True)
