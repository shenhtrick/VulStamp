...
tokenizer = RobertaTokenizer.from_pretrained('../../models/codebert', do_lower_case=True)
...
model = RobertaForSequenceClassification.from_pretrained('../../models/codebert', num_labels=4).to(device)
