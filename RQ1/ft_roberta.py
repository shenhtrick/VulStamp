...
tokenizer = RobertaTokenizer.from_pretrained('../../models/roberta', do_lower_case=True)
...
model = RobertaForSequenceClassification.from_pretrained('../../models/roberta', num_labels=4).to(device)
